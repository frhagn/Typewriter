	...
	public abstract class PropertyTests : TestBase
	{
		...
		public void Expect_primitive_properties_to_be_primitive()
		{
			...
			foreach (var property in properties)
			{
				...
				propertyInfo.Type.IsDateTimeOffset.ShouldBeFalse($"IsDateTimeOffset {property}");
		...
		[Fact]
		public void Expect_datetimeoffset_properties_to_be_primitive()
		{
			var properties = new [] { "DateTimeOffset" };
			...
			foreach (var property in properties)
			{
				...
				propertyInfo.Type.IsPrimitive.ShouldBeTrue($"IsPrimitive {property}");
				propertyInfo.Type.IsDate.ShouldBeTrue($"IsDate {property}");
				propertyInfo.Type.IsDateTimeOffset.ShouldBeTrue($"IsDateTimeOffset {property}");
				propertyInfo.Type.IsGuid.ShouldBeFalse($"IsGuid {property}");
				propertyInfo.Type.IsTimeSpan.ShouldBeFalse($"IsTimeSpan {property}");
		...
		public void Expect_guid_properties_to_be_primitive()
		{
			...
			propertyInfo.Type.IsDateTimeOffset.ShouldBeFalse("IsDateTimeOffset");
		...
		public void Expect_enum_properties_to_be_enums()
		{
			...
			enumInfo.Type.IsDateTimeOffset.ShouldBeFalse("IsDateTimeOffset");
		...
		public void Expect_nullable_enum_properties_to_be_enums()
		{
			...
			nullableEnumInfo1.Type.IsDateTimeOffset.ShouldBeFalse("IsDateTimeOffset");
			...
			nullableEnumInfo2.Type.IsDateTimeOffset.ShouldBeFalse("IsDateTimeOffsite");
